 ...
 */
final class Version20200331051947 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_surat ADD id_surat_status_id INT NOT NULL, CHANGE no_surat_rt no_surat_rt VARCHAR(255) DEFAULT NULL, CHANGE no_surat_rw no_surat_rw VARCHAR(255) DEFAULT NULL, CHANGE no_surat_lurah no_surat_lurah VARCHAR(255) DEFAULT NULL, CHANGE body_surat body_surat VARCHAR(255) DEFAULT NULL, CHANGE no_surat_keterangan no_surat_keterangan INT DEFAULT NULL, CHANGE keterangan keterangan VARCHAR(255) DEFAULT NULL, CHANGE tgl_selesai_rt tgl_selesai_rt DATETIME DEFAULT NULL, CHANGE tgl_selesai_rw tgl_selesai_rw DATETIME DEFAULT NULL, CHANGE tgl_selesai_kelurahan tgl_selesai_kelurahan DATETIME DEFAULT NULL, CHANGE tgl_buat tgl_buat DATETIME DEFAULT NULL, CHANGE tgl_selesai tgl_selesai DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE nd_surat ADD CONSTRAINT FK_BC0A2678A525AC9D FOREIGN KEY (id_surat_status_id) REFERENCES status_surat (id)');
        $this->addSql('CREATE INDEX IDX_BC0A2678A525AC9D ON nd_surat (id_surat_status_id)');
