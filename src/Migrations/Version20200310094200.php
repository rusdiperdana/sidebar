 ...
 */
final class Version20200310094200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_reader ADD refid_id INT NOT NULL');
        $this->addSql('ALTER TABLE nd_reader ADD CONSTRAINT FK_8E6951183512AFCB FOREIGN KEY (refid_id) REFERENCES nd_surat (id)');
        $this->addSql('CREATE INDEX IDX_8E6951183512AFCB ON nd_reader (refid_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_reader DROP FOREIGN KEY FK_8E6951183512AFCB');
        $this->addSql('DROP INDEX IDX_8E6951183512AFCB ON nd_reader');
        $this->addSql('ALTER TABLE nd_reader DROP refid_id');
