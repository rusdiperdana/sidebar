 ...
 */
final class Version20200310094443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_penerima ADD refid_id INT NOT NULL');
        $this->addSql('ALTER TABLE nd_penerima ADD CONSTRAINT FK_66E69E263512AFCB FOREIGN KEY (refid_id) REFERENCES nd_surat (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_66E69E263512AFCB ON nd_penerima (refid_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_penerima DROP FOREIGN KEY FK_66E69E263512AFCB');
        $this->addSql('DROP INDEX UNIQ_66E69E263512AFCB ON nd_penerima');
        $this->addSql('ALTER TABLE nd_penerima DROP refid_id');
