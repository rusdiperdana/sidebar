 ...
 */
final class Version20200310095842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE surat_kelurahan ADD refid_id INT NOT NULL');
        $this->addSql('ALTER TABLE surat_kelurahan ADD CONSTRAINT FK_E1DFAB3512AFCB FOREIGN KEY (refid_id) REFERENCES nd_surat (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E1DFAB3512AFCB ON surat_kelurahan (refid_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE surat_kelurahan DROP FOREIGN KEY FK_E1DFAB3512AFCB');
        $this->addSql('DROP INDEX UNIQ_E1DFAB3512AFCB ON surat_kelurahan');
        $this->addSql('ALTER TABLE surat_kelurahan DROP refid_id');
