 ...
 */
final class Version20200321005236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_kata_dasar ADD status_kata INT NOT NULL, CHANGE kata_dasar kata_dasar VARCHAR(255) DEFAULT NULL, CHANGE keterangan keterangan VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nd_kata_dasar DROP status_kata, CHANGE kata_dasar kata_dasar VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE keterangan keterangan VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
