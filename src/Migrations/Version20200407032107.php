 ...
 */
final class Version20200407032107 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tracking_item (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE nd_reader CHANGE reader_jabatan reader_jabatan INT DEFAULT NULL');
        $this->addSql('ALTER TABLE nd_surat CHANGE no_surat_rt no_surat_rt VARCHAR(255) DEFAULT NULL, CHANGE no_surat_rw no_surat_rw VARCHAR(255) DEFAULT NULL, CHANGE body_surat body_surat VARCHAR(255) DEFAULT NULL, CHANGE no_surat_keterangan no_surat_keterangan VARCHAR(255) DEFAULT NULL, CHANGE keterangan keterangan VARCHAR(255) DEFAULT NULL, CHANGE tgl_selesai_rt tgl_selesai_rt DATETIME DEFAULT NULL, CHANGE tgl_selesai_rw tgl_selesai_rw DATETIME DEFAULT NULL, CHANGE tgl_selesai_kelurahan tgl_selesai_kelurahan DATETIME DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE tgl_buat tgl_buat DATETIME DEFAULT NULL, CHANGE tgl_selesai tgl_selesai DATETIME DEFAULT NULL, CHANGE idSuratStatus idSuratStatus INT DEFAULT NULL, CHANGE pengirim_nama_text pengirim_nama_text VARCHAR(255) DEFAULT NULL, CHANGE reject_step reject_step INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE tracking_item');
